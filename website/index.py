...
def gxo():
    return render_template("gxo.html")

@homePage.route("/disp/<content>", methods=['GET', 'POST'])
def display(content):
    print(content)
    image = 'gxo/map_media/maxresdefault.jpg'
    video = 'gxo/map_media/istockphoto-463918882-640_adpp_is.mp4'
    if content == 'Russ':
        return render_template("display.html", image = image)
    if content == 'Bathroom':
        return render_template("display.html", image = image)
    if content == 'Loading_1':
        return render_template("display.html", image = 'gxo/map_media/truck-loading-goods.1.1.jpg')
    if content == 'Loading_2':
        return render_template("display.html", image = 'gxo/map_media/19710556_m.jpg')
    if content == 'Loading_3':
        return render_template("display_video.html", video = 'gxo/map_media/istockphoto-1366683418-640_adpp_is.mp4')
    if content == 'New_Pick':
        return render_template("display.html", image = 'gxo/map_media/maxresdefault.jpg')
    if content == 'Damage':
        return render_template("display.html", image = image)
    if content == 'Charging':
        return render_template("display_video.html", video = 'gxo/map_media/istockphoto-1400033393-640_adpp_is.mp4')
    if content == 'Office':
        return render_template("display_video.html", video = 'gxo/map_media/istockphoto-1201224615-640_adpp_is.mp4')
    if content == 'Break':
        return render_template("display_video.html", video = 'gxo/map_media/istockphoto-463918882-640_adpp_is.mp4')
    if content == 'Forklift':
        return render_template("display.html", image = image)
    if content == 'Wrapping':
        return render_template("display_video.html", video = 'gxo/map_media/istockphoto-1166568867-640_adpp_is.mp4')
    if content == 'Amazon':
        return render_template("display_video.html", video = 'gxo/map_media/istockphoto-1334942634-640_adpp_is.mp4')
    if content == 'Unloading':
        return render_template("display.html", image = 'gxo/map_media/Manc-Airport-PR-image-3.jpg')
    return render_template("display.html", image = image)
